...
public class VivaFieldFinder {
    ...
    public static class Builder implements VivaBuilder<VivaFieldFinder> {
        protected Class clazz;
        protected String fieldName;
        ...
        @Override
        public VivaFieldFinder build() {
            return new VivaFieldFinder(clazz, fieldName);
        }
    }
}
