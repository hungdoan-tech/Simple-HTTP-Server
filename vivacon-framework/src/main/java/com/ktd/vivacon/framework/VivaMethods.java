...
public final class VivaMethods {
    private VivaMethods() {}
    ...
    public static Method getMethod(
        ...
        return new VivaMethodFinder(clazz, methodName, parameterTypes).find();
    }
    ...
    public static List<Method> getDeclaredMethods(Class clazz) {
        return VivaLists.newArrayList(clazz.getDeclaredMethods());
    }
    ...
    public static List<VivaMethod> filterOverriddenMethods(Collection<VivaMethod> allMethods) {
        List<VivaMethod> methods = new ArrayList<>();
        for (VivaMethod i : allMethods) {
            boolean valid = true;
            for (VivaMethod k : methods) {
                if (isOverriddenMethod(i, k)) {
                    valid = false;
                    break;
                }
    ...
    public static boolean isOverriddenMethod(VivaMethod a, VivaMethod b) {
