...
public final class VivaStrings {
    ...
    public static String toDotCase(String original) {
        ...
        for (int i = 0; i < original.length(); ++i) {
            ...
            if (Character.isUpperCase(ch) && i > 0) {
                builder.append(VivaNamingCase.DOT.getSign());
            }
        ...
        return builder
                ...
                .replace(VivaNamingCase.DASH.getSign(), VivaNamingCase.DOT.getSign())
                .replace(VivaNamingCase.UNDERSCORE.getSign(), VivaNamingCase.DOT.getSign())
                .replace(VivaNamingCase.DOT.getSign() + VivaNamingCase.DOT.getSign(), VivaNamingCase.DOT.getSign());
    }

    public static String toDashCase(String original) {
        return toDotCase(original).replace(VivaNamingCase.DOT.getSign(), VivaNamingCase.DASH.getSign());
    }

    public static String toUnderscoreCase(String original) {
        return toDotCase(original).replace(VivaNamingCase.DOT.getSign(), VivaNamingCase.UNDERSCORE.getSign());
    }
