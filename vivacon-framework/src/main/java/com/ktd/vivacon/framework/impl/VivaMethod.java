...
import static com.ktd.vivacon.framework.VivaReflections.*;

@Getter
public class VivaMethod implements VivaReflectElement {
    protected final Method method;

    @Setter
    protected String displayName;

    public VivaMethod(Method method) {
        this.method = method;
    ...
    public Object invoke(Object obj, Object... args) {
        return VivaMethods.invoke(method, obj, args);
    }
    ...
    public boolean equals(Object obj) {
        return new VivaEquals<VivaMethod>()
                .function(m -> m.method)
                .isEquals(this, obj);
    }
    ...
    @SuppressWarnings("rawtypes")
    public static class Builder implements VivaBuilder<VivaMethod> {
        ...
        @Override
        public VivaMethod build() {
            return new VivaMethod(getMethod());
        }

        protected Method getMethod() {
            return VivaMethods.getMethod(clazz, methodName, getParameterTypes());
        }
